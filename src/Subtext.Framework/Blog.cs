...
namespace Subtext.Framework
{
    ...
    public class Blog
    {
		...
		/// <summary>
		/// Gets or sets a value indicating whether the default content type for new 
		/// entries is Markdown.
		/// </summary>
		/// <value>
		/// 	<c>true</c> if Markdown is the default content type, otherwise, <c>false</c>.
		/// </value>
		public bool DefaultContentTypeIsMarkdown {
			get { return FlagPropertyCheck(ConfigurationFlags.DefaultContentTypeIsMarkdown); }
			set { FlagSetter(ConfigurationFlags.DefaultContentTypeIsMarkdown, value); }
		}
