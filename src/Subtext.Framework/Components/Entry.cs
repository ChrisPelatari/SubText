...
namespace Subtext.Framework.Components
{
    ...
    public class Entry : IEntryIdentity
    {
		...
		/// <summary>
		/// If true, a new Entry's Body property will be saved as
		/// Markdown instead of (x)html.
		/// </summary>
		public bool ContentTypeIsMarkdown {
			get { return EntryPropertyCheck(PostConfig.ContentTypeIsMarkdown); }
			set { PostConfigSetter(PostConfig.ContentTypeIsMarkdown, value); }
		}
