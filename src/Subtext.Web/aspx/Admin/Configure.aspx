...
<asp:Content ContentPlaceHolderID="pageContent" runat="server">
    ...
    <div class="Edit" id="configure-form">
        <asp:Panel runat="server" GroupingText="Main Settings" CssClass="options">
            ...
            <div>
                <asp:CheckBox ID="ckbDefaultContentTypeIsMarkdown" runat="server" TextAlign="Right" CssClass="checkbox" AccessKey="m"
                    Text="Use <u>M</u>arkdown for new posts instead of (x)html" />
            </div><div>
